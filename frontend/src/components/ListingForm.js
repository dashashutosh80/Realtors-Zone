            ...
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        ...
                        <select className='listingform__select' name='price' onChange={e => onChange(e)} value={price}>
                            ...
                            <option>Rs 40,00,000+</option>
                            <option>Rs 60,00,000+</option>
                            <option>Rs 80,00,000+</option>
                            <option>Rs 1,00,00,000+</option>
                            <option>Rs 1,50,00,000+</option>
                            <option>Rs 2,00,00,000+</option>
                            <option>Any</option>
                        </select>
                    </div>
                    <div className='listingform__section'>
                ...
                <div className='col-1-of-6'>
                    {loading ?
                        ...
                        </div> : <button className='listingform__button listingform__button__primary'>Save</button>
                    }
                </div>
            </div>
        </form>
